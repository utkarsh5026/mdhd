...
import { DocumentLinkProvider } from '@/components/features/markdown-render';
...
import { useDocumentLinks } from '../hooks/use-document-links';
  ...
  ({ viewMode, headerSlot, editModeContent, onSectionClick, onPresent }) => {
    ...
    return (
      <TTSContext.Provider value={tts}>
        <DocumentLinkProvider value={documentLinks}>
