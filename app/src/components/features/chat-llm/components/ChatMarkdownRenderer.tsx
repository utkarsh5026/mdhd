...
const ChatMarkdownRenderer: React.FC<ChatMarkdownRendererProps> = ({
  ...
  // FIX: Memoize components to prevent unnecessary re-renders
  const components = React.useMemo(
    () => ({
      ...
      ul: ({ children }: { children: React.ReactNode }) => (
        <ul className="ml-4 mb-3 last:mb-0 list-disc space-y-1.5">
          {children}
        </ul>
      ),
          ...
          >
            ...
            <SyntaxHighlighter
              ...
              customStyle={{
                ...
                // FIX: Remove opacity animation during streaming
                opacity: 1,
              }}
              wrapLongLines
              codeTagProps={{
