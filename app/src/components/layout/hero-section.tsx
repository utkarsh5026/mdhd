  ...
  return (
    <div className={`text-center space-y-8 mb-16 ${styles.container}`}>
      <div className="relative">
        <h1 className={`text-4xl md:text-6xl lg:text-7xl font-black tracking-tight ${styles.title}`}>
          <span className="text-foreground relative">Transform Markdown</span>
        </h1>
        <p className={`text-xl md:text-2xl text-muted-foreground mt-6 max-w-3xl mx-auto ${styles.subtitle}`}>
